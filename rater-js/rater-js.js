// Custom RPS mod of https://github.com/fredolss/rater-js
...
function raterJs(options) {
	...
	// RPS
	let maskSize = starSize + "px " + starSize + "px";
	div.style.maskSize = maskSize;
	div.style.webkitMaskSize = maskSize;
	...
	// RPS
	elem.style.maskSize = maskSize;
	elem.style.webkitMaskSize = maskSize;
